...
function updateNavBar() {
    if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100 || window.innerWidth < 1080) {
        ...
        document.getElementById("navHome").style.paddingTop = "8px";
        document.getElementById("navHome").style.paddingBottom = "8px";
        document.getElementById("navHome").style.backgroundColor = "#303030";
